...
<!--<script src="http://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>-->
        ...
        <script src="<?php echo base_url('template_specific/order_view.js'); ?>"></script>

        <link rel="stylesheet" type="text/css" href="<?php echo base_url('template_specific/order_view.css'); ?>">
...
//                    echo "<button>$i</button>";
                ?>
                <a href="<?php echo site_url('sale/order'); ?>"> <button>New</button> </a>
...
//                
            ...
            <div class="bill_print" id="bill_print">
                ...
                <form id="bill_save" action="<?php echo site_url('sale/order/save_order'); ?>" method="post" target="_blank">
                    ...
                    <span id="show_duplicate" style="display: none; padding: 5px; border: 1px solid black; text-align: center; margin-left: 150px; margin-top: 10px;">Duplicate Copy</span> 
                    <table id="bill_info" class="bill_info">
                        ...
                        <tr>
                            <?php
                            $last_order_id = $this->db->select_max('order_id')->get('order')->result()[0]->order_id;
                            ...
                            <td>Order No:</td>
                            <td>
                                <input type="text" name="order_number" id="order_number" value="<?php echo 'AW-' . $next_order_id; ?>" style="width: 100px;" readonly />
                            </td>
                        </tr>
                        <tr>
                            <td>SL#</td>
                    ...
                    <table id="bill_calculated" class="bill_calculated">

                        <tr>
                   <!--<span id="sub_total_container" style="display: none;">-->
                            <td class="second_line_border"><span class="sub_total_container" style="display: none;">Sub Total:</span></td>
                            <td class="second_line_border"></td>
                            <td class="second_line_border"></td>
                            <td class="second_line_border"></td>
                            <td class="second_line_border"><span class="sub_total_container" style="display: none;"><input name="sub_total" id="sub_total" style="width: 110px;" readonly /></span></td>
                            <!--</span>-->
                        </tr>
                        <tr>
                            <?php
                            ...
                            ?>
                            <td><span class="vat_container" style="display: none;">+VAT(<?php echo $vat_percentage; ?>%)</span></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td><span class="vat_container" style="display: none;"><input type="text" name="vat" id="vat" style="width: 110px;" readonly /></span></td>
                        </tr>
                        <tr>
                        <!--<span id="discount_last_container" style="display: none;">-->
                            <td><span class="discount_last_container" style="display: none;">-Discount:</span></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td><span class="discount_last_container" style="display: none;"><input type="text" name="discount_last" id="discount_last" style="width: 110px;" readonly /></span></td>
                            <!--</span>-->
                        </tr>
                        <tr>
                            <td><span class="net_due_container" style="display: none;">Net Due</span></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td><span class="net_due_container" style="display: none;"><input type="text" name="net_due" id="net_due" style="width: 110px;" readonly /></span></td>
                        </tr>
                        <tr>
                            <td><span class="payment_container" style="display: none;">Paid:</span></td>                        
                            <td></td>
                            <td></td>
                            <td></td>
                            <td><span class="payment_container" style="display: none;"><input type="text" name="payment_amount" id="payment_amount" style="width: 110px;" readonly /></span></td>
                        </tr>
                        <tr>
                            <td><span class="payment_container" style="display: none;">Change</span></td>                       
                            <td></td>
                            <td></td>
                            <td></td>
                            <td><span class="payment_container" style="display: none;"><input type="text" name="change_amount" id="change_amount" style="width: 110px;" readonly /></span></td>
                        </tr>


                        <tr>
                            <td colspan="5"> <span class="payment_container" style="display: none;">Payment Mode:</span></td>
                        </tr>
                        <tr>
                            <td><span class="payment_container" style="display: none;">
                                    <input type="text" name="payment_method_id" id="payment_method_id" style="display: none;" /> 
                                    <input type="text" name="payment_method_name" id="payment_method_name" readonly />        
                                </span></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td><span class="payment_container" style="display: none;"><input type="text" name="net_due_show" id="net_due_show" style="width: 110px;" readonly /></span></td>
                        </tr>



                        <tr>
                            <td colspan="4"><span class="discount_last_container" style="display: none;">Discount Name:</span></td>
                            <td><span class="discount_last_container" style="display: none;"><span id="discount_name_invoice"></span></span></td>
                        </tr>
                        <tr>
                            <td colspan="5"><span class="discount_last_container" style="display: none;">You have saved <span id="discount_amount_invoice"></span></span></td>
                        </tr>

                        <tr>
                            <td colspan="5"><span class="invoice_message" style="display: none; width: 200px;">
                                    <?php
...
<!--                        <tr>
                            <td colspan="5"><span class="development_info" style="display: none;">Developed By Zaman IT</span></td>
                        <td><span class="development_info" style="display: none;">
...
<!--                        <span id="payment_container" style="display: none;">       
                    ...
                    <table id="bill_additional" class="bill_additional" style="display: none">
                        <tr>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <select class="form-control" id="payment_method_enter">
                            <?php
                            $this->db->where('status', 'active');
                            $payment_method_query = $this->db->get('payment_method');
                            foreach ($payment_method_query->result() as $payment_method_row) {
                                echo '<option value="' . $payment_method_row->id . '">' . $payment_method_row->description . '</option>';
                            }
                            ?>
                        </select>
                    </td>
        ...
        <script>
            function bill_save_fn() {
                if (typeof (form_submit_counter) == 'undefined') {
                    order_type_input = document.getElementById('order_type').value;
                    payment_method_id_input = document.getElementById('payment_method_id').value;
                    payment_amount_input = document.getElementById('payment_amount').value;

                    if ((order_type_input == "") || (payment_method_id_input == "") || (payment_amount_input == "")) {
                        alert('Please insert Order type, Payment method, Payment amount');
                    } else {
