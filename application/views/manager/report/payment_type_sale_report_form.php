...
<form action="<?php echo site_url('manager/report/payment_type_sale_report_excel');?>" method="post" target="_blank">
    <table>
    <tr>
        <td>From Date: </td>
        <td>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#report").click(function () {
            ...
            to_date = $('#to_date').val();
            $.post("<?php echo site_url('manager/report/payment_type_sale_report_result'); ?>",
                    {
                        from_date: from_date,
                        to_date: to_date
                    },
