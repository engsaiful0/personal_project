...
<!--            <li class="topfirst"><a href="#" style="height:18px;line-height:18px;"><span>Entry</span></a>
                <ul>
                    <li><a href="<?php echo site_url() . '/manager/entry/customer_entry'; ?>">Customer</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/supplier_entry'; ?>">Supplier</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/staff_entry'; ?>">Staff</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/shop_entry'; ?>">Shop</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/extra_item_group_entry'; ?>">Extra Item Group</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/instruction_entry'; ?>">Instruction</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/item_entry'; ?>">Item</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/item_group_entry'; ?>">Item Group</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/branch_entry'; ?>">Branch</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/job_title_entry'; ?>">Job Title</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/measurement_entry'; ?>">Measurement</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/payment_method_entry'; ?>">Payment Method</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/promotional_discount_entry'; ?>">Promotional Discount</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/scrolling_message_entry'; ?>">Scrolling Message</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/special_discount_entry'; ?>">Special Discount</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/cash_register_entry'; ?>">Cash Register</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/tax_entry'; ?>">Tax</a></li>
                    <li><a href="<?php echo site_url() . '/manager/entry/invoice_message_entry'; ?>">Invoice Message</a></li>
                </ul></li>-->
...
<!--                    <li><a href="#"><span>Item 1 0</span></a>
                    ...
                    <li><a href="<?php echo site_url() . '/manager/transaction/item_requisition_entry'; ?>">Item Requisition</a></li>
                    <li><a href="<?php echo site_url() . '/manager/transaction/item_receiving_entry'; ?>">Item Receiving</a></li>
                    <li><a href="<?php echo site_url() . '/manager/transaction/item_dispose_entry'; ?>">Item Dispose</a></li>
                    <li><a href="<?php echo site_url() . '/manager/transaction/item_process_entry'; ?>">Item Process</a></li>
                    <li><a href="<?php echo site_url() . '/manager/transaction/stock_reconciliation_entry'; ?>">Stock Reconciliation</a></li>
                    <li><a href="<?php echo site_url() . '/manager/transaction/cash_reconciliation_entry'; ?>">Cash Reconciliation</a></li>
...
<!--                    <li><a href="#"><span>Item 1 0</span></a>
                    ...
                    <li><a href="<?php echo site_url() . '/manager/security/user_setup'; ?>">User Setup</a></li>

                </ul></li>


            <li class="topfirst"><a href="<?php echo site_url('login/logout'); ?>" style="height:18px;line-height:18px;"><span>Manager Log Out</span></a></li>
