...
class Entry extends CI_Controller {
    ...
    public function item_entry() {
        ...
        $crud->set_relation('promotional_discount_id', 'promotional_discount', 'description');
        $crud->field_type('status', 'dropdown', array('active' => 'Active','inactive' => 'Inactive'));
        $crud->set_field_upload('image', 'upload/item_specific');
        $output = $crud->render();
        $this->load->view('admin/entry_view', $output);
    }
    ...
    public function item_group_entry() {
        ...
        $crud->field_type('status', 'dropdown', array('active' => 'Active','inactive' => 'Inactive'));
        $crud->set_field_upload('image', 'upload/item_group');
        $output = $crud->render();
        $this->load->view('admin/entry_view', $output);
    }
    ...
    public function payment_method_entry() {
        ...
        $crud->field_type('status', 'dropdown', array('active' => 'Active','inactive' => 'Inactive'))->field_type('description', 'readonly');
        $output = $crud->render();
        $this->load->view('admin/entry_view', $output);
    }
